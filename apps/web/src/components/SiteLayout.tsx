            ...
            {menu.map((item) => (
              ...
              >
                <NavLink
                  to={item.to}
                  className={({ isActive }) =>
                    `relative flex h-[4.5rem] items-center px-6 text-[1.05rem] font-semibold tracking-tight transition ${
                      transparent
                        ? isActive
                          ? 'text-white'
                ...
                >
                  ...
                  <span
                    aria-hidden
                    className={`absolute inset-x-6 bottom-3 h-px origin-left scale-x-0 transition-transform duration-200 ease-in-out group-hover:scale-x-100 ${
                ...
                {item.children.length > 0 && (
                  <ul className="absolute left-0 top-[4.5rem] flex w-44 flex-col gap-2.5 px-6 pt-5">
